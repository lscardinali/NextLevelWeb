...
<div class="flex flex-col">
	...
	<div class="mx-2 my-2 grid grid-cols-1 gap-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
		<a
			href="/hub/subscriptions"
			class="flex h-20 flex-row items-center justify-evenly rounded-xl bg-gradient-to-tr from-green-950 to-green-700 p-4 transition-all active:opacity-50"
		>
			<IconXbox />
			<h1 class=" text-xl font-bold">Xbox Game Pass</h1>
		</a>

		<a
			href="/hub/subscriptions"
			class="flex h-20 flex-row items-center justify-evenly rounded-xl bg-gradient-to-tr from-blue-950 to-blue-700 p-4 transition-all active:opacity-50"
		>
			<IconPlaystation />
		...
		<a
			href="/hub/subscriptions"
			class="relative flex h-20 items-center justify-evenly rounded-xl bg-gradient-to-br from-neutral-950 to-neutral-700 p-4"
		>
			<IconEpicGameStore />
			<h1 class=" text-xl">Epic Games Store Free Game</h1>
		</a>
	</div>
